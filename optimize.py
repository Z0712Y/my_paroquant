...
class Config:
    ...
    # 通道对选择策略: "random" 保留原随机洗牌; "greedy" 使用基于显著性分数的贪心选择; "softmax" 使用基于显著性的加权随机采样
    selection_mode: str = "random"
    # 显著性分数计算指标: "l2" | "maxabs" | "var"，仅在 selection_mode="greedy" / "softmax" 时生效
    metric: str = "l2"
    # softmax 采样温度，仅在 selection_mode="softmax" 时生效。T->0 接近贪心，T->∞ 接近均匀随机
